		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					<li class="nav-item"><a class="nav-link active" aria-current="page" href="<%=url %>/admin.jsp">Trang chủ</a></li>
					<li class="nav-item"><a class="nav-link" href="<%=url %>/quanlysanpham.jsp">Quản lý sản phẩm</a></li>
					<li class="nav-item"><a class="nav-link" href="<%=url %>/quanlykhachhang.jsp">Quản lý khách hàng</a></li>
				</ul>
				<form action="search" method="get" class="d-flex m-0" role="search">
					...
					<ul class="navbar-nav me-auto mb-2 mb-lg-0 bg-infor ">
						<li class="nav-item dropstart"><a class="dropdown-item" href="dang-xuat"><i class="fas fa-sign-out-alt"></i>Thoát tài khoản</a>
