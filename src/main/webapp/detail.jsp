			...
			<div class="container-fliud">
				<div class="row">
					...
					<div class="details col-md-6">
						...
						<h6 style="color: red"><i class="fa-brands fa-gratipay"></i>${detail.tym} lượt yêu thích</h6>
						<h6 style="color: green"><i class="fa-solid fa-warehouse"></i></i>Còn trong kho ${detail.soluongcon} sản phẩm</h6>
						<div class="rating">
							<div class="stars">
						...
						<div class="action">
							<a href="add-to-cart?id=${detail.id}" class="add-to-cart btn btn-default" type="button"><i class="fas fa-cart-plus"></i>Thêm vào giỏ hàng</a>
...
editButtons.forEach(function(button) {
  button.addEventListener('click', function() {
    ...
    var content = button.getAttribute('data-comment-content');
