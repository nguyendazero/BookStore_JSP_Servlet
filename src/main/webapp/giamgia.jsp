...
<%
	...
	List<Product> products = pd.getGiamGiaProducts();
...
<style type="text/css">
    ...
    .product-price_goc {
    	...
    	color: #999; /* Màu của giá gốc có thể thay đổi tùy ý */
        color: black; /* Màu chữ giá sản phẩm */
    }
				...
				<%
					if(!products.isEmpty()){
						for(Product p:products){%>
							...
							<div class="card h-80" style="height: 550px">
								...
								<h6 class="text-center product-price_goc"><%= p.getPrice_goc() %>đ</h6>
