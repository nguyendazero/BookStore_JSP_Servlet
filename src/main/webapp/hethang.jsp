...
<%
	...
	List<Product> products = pd.getHetHangProducts();
...
<style type="text/css">
    ...
    .add-to-cart-button {
        font-size: 14px;
        font-weight: bold;
        background-color: #BEBEBE; /* Màu nền nút */
						...
						for(Product p:products){%>
							...
							<div class="card h-80" style="height: 530px">
								...
								<div class="card-footer">
									...
									<a class="btn add-to-cart-button" style="float: right">Đã hết hàng</a>
								</div>
							</div>
						</div>	
						<%}
