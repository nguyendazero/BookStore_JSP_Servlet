	...
	<div class="container c1">
		<div class="container c2 py-3 d-flex">
		  <form action="search-admin" method="get" class="d-flex" role="search">
		    <input value="${txtS}" name="txt" class="form-control me-2" type="text" placeholder="Tìm kiếm sản phẩm" aria-label="Search">
							          ...
							          <div class="card-body">
							            <div class="row">
							              ...
							              <div class="col-md-6 col-lg-6 col-xl-6">
							                ...
							                <div class="mt-1 mb-3 text-muted small">
							                  <span>Số lượng còn trong kho:  <%= p.getSoluongcon()%></span>
							                </div>
